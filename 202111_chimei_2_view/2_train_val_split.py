"""
train val split, set the validation ratio or set a fix number in line 18/19
"""
import os
import random
# set folder paths
...
val_folder = "to_Azure/chimei_2v_t_v/val/"
val_label_folder = "to_Azure/chimei_2v_t_v/valannot/"
